...
} cobs_encode_status_t;

typedef struct
{
    size_t                  out_len;
    cobs_encode_status_t    status;
} cobs_encode_result_t;
...
} cobs_decode_status_t;

typedef struct
{
    size_t                  out_len;
    cobs_decode_status_t    status;
} cobs_decode_result_t;
 ...
 *                 dst_buf_ptr)
 */
cobs_encode_result_t cobs_encode(void * dst_buf_ptr, size_t dst_buf_len,
 ...
 *                 dst_buf_ptr)
 */
cobs_decode_result_t cobs_decode(void * dst_buf_ptr, size_t dst_buf_len,
                               const void * src_ptr, size_t src_len);
