        ...
        case UART_RX_RDY:
            ...
            if (pos != old_pos) 
            {
                ...
                if (pos > old_pos) 
                {
                    ...
                    bm_util_linear_memcpy(( uint8_t* )encoded_rx_buf[write_buf_idx].buf, &buf[old_pos], pos-old_pos);
                ...
                else
                {
                    ...
                    bm_util_linear_memcpy(( uint8_t* ) encoded_rx_buf[write_buf_idx].buf, &buf[old_pos], buf_len-old_pos);
                    encoded_rx_buf[write_buf_idx].length = (buf_len-old_pos);
                    if (pos) 
                    {
                        bm_util_linear_memcpy(( uint8_t* ) &encoded_rx_buf[write_buf_idx].buf[buf_len-old_pos], &buf[0], pos);
