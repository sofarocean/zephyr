...
#define ADDR_MAC_TX_PRI                                          (0X035U)    /* LES Tx Priority Register. */
...
#define ADDR_MAC_P1TOP2_TXSIZE                                   (0X0BCU)    /* P1 to P2 TX Size. */
#define ADDR_MAC_P2_RX_FSIZE                                     (0X0C0U)    /* P2 MAC Rx Frame Size Register. */
#define ADDR_MAC_P2_RX                                           (0X0C1U)    /* P2 MAC Receive Register. */
#define ADDR_MAC_P2_RX_FRM_CNT                                   (0X0D0U)    /* P2 Rx Frame Count Register. */
#define ADDR_MAC_P2_RX_BCAST_CNT                                 (0X0D1U)    /* P2 Rx Broadcast Frame Count Register. */
#define ADDR_MAC_P2_RX_MCAST_CNT                                 (0X0D2U)    /* P2 Rx Multicast Frame Count Register. */
#define ADDR_MAC_P2_RX_UCAST_CNT                                 (0X0D3U)    /* P2 Rx Unicast Frame Count Register. */
#define ADDR_MAC_P2_RX_CRC_ERR_CNT                               (0X0D4U)    /* P2 Rx CRC Errored Frame Count Register. */
#define ADDR_MAC_P2_RX_ALGN_ERR_CNT                              (0X0D5U)    /* P2 Rx Align Error Count Register. */
#define ADDR_MAC_P2_RX_LS_ERR_CNT                                (0X0D6U)    /* P2 Rx Long/Short Frame Error Count Register. */
#define ADDR_MAC_P2_RX_PHY_ERR_CNT                               (0X0D7U)    /* P2 Rx PHY Error Count Register. */
#define ADDR_MAC_P2_TX_FRM_CNT                                   (0X0D8U)    /* P2 Tx Frame Count Register. */
#define ADDR_MAC_P2_TX_BCAST_CNT                                 (0X0D9U)    /* P2 Tx Broadcast Frame Count Register. */
#define ADDR_MAC_P2_TX_MCAST_CNT                                 (0X0DAU)    /* P2 Tx Multicast Frame Count Register. */
#define ADDR_MAC_P2_TX_UCAST_CNT                                 (0X0DBU)    /* P2 Tx Unicast Frame Count Register. */
#define ADDR_MAC_P2_RX_DROP_FULL_CNT                             (0X0DCU)    /* P2 Rx Frames Dropped Due to FIFO Full Register. */
#define ADDR_MAC_P2_RX_DROP_FILT_CNT                             (0X0DDU)    /* P2 Rx Frames Dropped Due to Filtering Register. */
#define ADDR_MAC_P2_RX_IFG_ERR_CNT                               (0X0DEU)    /* Frames Received on Port 2 with IFG Errors. */
#define ADDR_MAC_P2_TX_IFG                                       (0X0E0U)    /* P2 Transmit Inter Frame Gap Register. */
#define ADDR_MAC_P2_LOOP                                         (0X0E3U)    /* P2 MAC Loopback Enable Register. */
#define ADDR_MAC_P2_RX_CRC_EN                                    (0X0E4U)    /* P2 CRC Check Enable on Receive Register. */
#define ADDR_MAC_P2_RX_IFG                                       (0X0E5U)    /* P2 Receive Inter Frame Gap Register. */
#define ADDR_MAC_P2_RX_MAX_LEN                                   (0X0E6U)    /* P2 Max Receive Frame Length Register. */
#define ADDR_MAC_P2_RX_MIN_LEN                                   (0X0E7U)    /* P2 Min Receive Frame Length Register. */
#define ADDR_MAC_P2_LO_RFC                                       (0X0E8U)    /* P2 Rx Low Priority FIFO Frame Count Register. */
#define ADDR_MAC_P2_HI_RFC                                       (0X0E9U)    /* P2 Rx High Priority Fifo Frame Count Register. */
#define ADDR_MAC_P2_LO_RXSIZE                                    (0X0EAU)    /* P2 Low Priority Rx FIFO Valid Half Words Register. */
#define ADDR_MAC_P2_HI_RXSIZE                                    (0X0EBU)    /* P2 High Priority Rx FIFO Valid Half Words Register. */
#define ADDR_MAC_P2TOP1_TXSIZE                                   (0X0ECU)    /* P2 to P1 TX Size. */
#define ADDR_MAC_P2_TTSCAH                                       (0X0F0U)    /* Transmit Timestamp Capture Register A (High). */
#define ADDR_MAC_P2_TTSCAL                                       (0X0F1U)    /* Transmit Timestamp Capture Register A (Low). */
#define ADDR_MAC_P2_TTSCBH                                       (0X0F2U)    /* Transmit Timestamp Capture Register B (High). */
#define ADDR_MAC_P2_TTSCBL                                       (0X0F3U)    /* Transmit Timestamp Capture Register B (Low). */
#define ADDR_MAC_P2_TTSCCH                                       (0X0F4U)    /* Transmit Timestamp Capture Register C (High). */
#define ADDR_MAC_P2_TTSCCL                                       (0X0F5U)    /* Transmit Timestamp Capture Register C (Low). */
...
#define RSTVAL_MAC_FIFO_SIZE                                       (0X2222222)
...
#define RSTVAL_MAC_P2_RX_DROP_FILT_CNT                             (0X0)
#define RSTVAL_MAC_P2_RX_IFG_ERR_CNT                               (0X0)
#define RSTVAL_MAC_P2_TX_IFG                                       (0XB)
...
#define RSTVAL_MAC_P2_LO_RFC                                       (0X0)
#define RSTVAL_MAC_P2_HI_RFC                                       (0X0)
#define RSTVAL_MAC_P2_LO_RXSIZE                                    (0X0)
#define RSTVAL_MAC_P2_HI_RXSIZE                                    (0X0)
#define RSTVAL_MAC_P2TOP1_TXSIZE                                   (0X0)
#define RSTVAL_MAC_P2_TTSCAH                                       (0X0)
#define RSTVAL_MAC_P2_TTSCAL                                       (0X0)
#define RSTVAL_MAC_P2_TTSCBH                                       (0X0)
#define RSTVAL_MAC_P2_TTSCBL                                       (0X0)
#define RSTVAL_MAC_P2_TTSCCH                                       (0X0)
#define RSTVAL_MAC_P2_TTSCCL                                       (0X0)
...
#define BITP_MAC_CONFIG2_PORT_CUT_THRU_EN                     (11U)          /* Enable Cut Through from Port to Port. */
#define BITL_MAC_CONFIG2_PORT_CUT_THRU_EN                     (1U)           /* Enable Cut Through from Port to Port. */
#define BITM_MAC_CONFIG2_PORT_CUT_THRU_EN                     (0X00000800U)  /* Enable Cut Through from Port to Port. */
#define BITP_MAC_CONFIG2_P2_FWD_UNK2HOST                      (12U)          /* Forward Frames Not Matching Any MAC Address to the Host. */
#define BITL_MAC_CONFIG2_P2_FWD_UNK2HOST                      (1U)           /* Forward Frames Not Matching Any MAC Address to the Host. */
#define BITM_MAC_CONFIG2_P2_FWD_UNK2HOST                      (0X00001000U)  /* Forward Frames Not Matching Any MAC Address to the Host. */
#define BITP_MAC_CONFIG2_P1_FWD_UNK2P2                        (13U)          /* Forward Frames from Port1 Not Matching a MAC Addr to Port2. */
#define BITL_MAC_CONFIG2_P1_FWD_UNK2P2                        (1U)           /* Forward Frames from Port1 Not Matching a MAC Addr to Port2. */
#define BITM_MAC_CONFIG2_P1_FWD_UNK2P2                        (0X00002000U)  /* Forward Frames from Port1 Not Matching a MAC Addr to Port2. */
#define BITP_MAC_CONFIG2_P2_FWD_UNK2P1                        (14U)          /* Forward Frames from Port2 Not Matching a MAC Addr to Port1. */
#define BITL_MAC_CONFIG2_P2_FWD_UNK2P1                        (1U)           /* Forward Frames from Port2 Not Matching a MAC Addr to Port1. */
#define BITM_MAC_CONFIG2_P2_FWD_UNK2P1                        (0X00004000U)  /* Forward Frames from Port2 Not Matching a MAC Addr to Port1. */
#define BITP_MAC_CONFIG2_RX_RD_ORDER                          (15U)          /* Rx Ports Read Order for the Open Alliance Data Protocol. */
#define BITL_MAC_CONFIG2_RX_RD_ORDER                          (1U)           /* Rx Ports Read Order for the Open Alliance Data Protocol. */
#define BITM_MAC_CONFIG2_RX_RD_ORDER                          (0X00008000U)  /* Rx Ports Read Order for the Open Alliance Data Protocol. */
#define BITP_MAC_CONFIG2_P2_RCV_IFG_ERR_FRM                   (16U)          /* Admit Frames with IFG Errors on P2. */
#define BITL_MAC_CONFIG2_P2_RCV_IFG_ERR_FRM                   (1U)           /* Admit Frames with IFG Errors on P2. */
#define BITM_MAC_CONFIG2_P2_RCV_IFG_ERR_FRM                   (0X00010000U)  /* Admit Frames with IFG Errors on P2. */

#define ENUM_MAC_CONFIG2_RX_RD_ORDER_FILL_LVL                 (0X00000000U)  /* Fill Level. */
#define ENUM_MAC_CONFIG2_RX_RD_ORDER_PING_PONG                (0X00000001U)  /* Ping Pong. */
...
#define BITP_MAC_STATUS1_P2_RX_RDY                            (17U)          /* Port2 Rx FIFO Contains Data. */
#define BITL_MAC_STATUS1_P2_RX_RDY                            (1U)           /* Port2 Rx FIFO Contains Data. */
#define BITM_MAC_STATUS1_P2_RX_RDY                            (0X00020000U)  /* Port2 Rx FIFO Contains Data. */
#define BITP_MAC_STATUS1_P2_RX_RDY_HI                         (18U)          /* Port2 Rx Ready High Priority. */
#define BITL_MAC_STATUS1_P2_RX_RDY_HI                         (1U)           /* Port2 Rx Ready High Priority. */
#define BITM_MAC_STATUS1_P2_RX_RDY_HI                         (0X00040000U)  /* Port2 Rx Ready High Priority. */
#define BITP_MAC_STATUS1_P2_PHYINT                            (19U)          /* PHY Interrupt for Port2. */
#define BITL_MAC_STATUS1_P2_PHYINT                            (1U)           /* PHY Interrupt for Port2. */
#define BITM_MAC_STATUS1_P2_PHYINT                            (0X00080000U)  /* PHY Interrupt for Port2. */
#define BITP_MAC_STATUS1_P2_TTSCAA                            (20U)          /* Transmit Timestamp Capture Available A. */
#define BITL_MAC_STATUS1_P2_TTSCAA                            (1U)           /* Transmit Timestamp Capture Available A. */
#define BITM_MAC_STATUS1_P2_TTSCAA                            (0X00100000U)  /* Transmit Timestamp Capture Available A. */
#define BITP_MAC_STATUS1_P2_TTSCAB                            (21U)          /* Transmit Timestamp Capture Available B. */
#define BITL_MAC_STATUS1_P2_TTSCAB                            (1U)           /* Transmit Timestamp Capture Available B. */
#define BITM_MAC_STATUS1_P2_TTSCAB                            (0X00200000U)  /* Transmit Timestamp Capture Available B. */
#define BITP_MAC_STATUS1_P2_TTSCAC                            (22U)          /* Transmit Timestamp Capture Available C. */
#define BITL_MAC_STATUS1_P2_TTSCAC                            (1U)           /* Transmit Timestamp Capture Available C. */
#define BITM_MAC_STATUS1_P2_TTSCAC                            (0X00400000U)  /* Transmit Timestamp Capture Available C. */
#define BITP_MAC_STATUS1_P2_RX_IFG_ERR                        (23U)          /* Rx MAC Inter Frame Gap Error. */
#define BITL_MAC_STATUS1_P2_RX_IFG_ERR                        (1U)           /* Rx MAC Inter Frame Gap Error. */
#define BITM_MAC_STATUS1_P2_RX_IFG_ERR                        (0X00800000U)  /* Rx MAC Inter Frame Gap Error. */
#define BITP_MAC_STATUS1_P2_TXFCSE                            (24U)          /* CRC Mismatch on a Tx Frame on P2. */
#define BITL_MAC_STATUS1_P2_TXFCSE                            (1U)           /* CRC Mismatch on a Tx Frame on P2. */
#define BITM_MAC_STATUS1_P2_TXFCSE                            (0X01000000U)  /* CRC Mismatch on a Tx Frame on P2. */
...
#define BITP_MAC_IMASK1_P2_RX_RDY_MASK                        (17U)          /* Mask Bit for P2_RX_RDY. */
#define BITL_MAC_IMASK1_P2_RX_RDY_MASK                        (1U)           /* Mask Bit for P2_RX_RDY. */
#define BITM_MAC_IMASK1_P2_RX_RDY_MASK                        (0X00020000U)  /* Mask Bit for P2_RX_RDY. */
#define BITP_MAC_IMASK1_P2_PHYINT_MASK                        (19U)          /* Mask Bit for P2_PHYINT. */
#define BITL_MAC_IMASK1_P2_PHYINT_MASK                        (1U)           /* Mask Bit for P2_PHYINT. */
#define BITM_MAC_IMASK1_P2_PHYINT_MASK                        (0X00080000U)  /* Mask Bit for P2_PHYINT. */
#define BITP_MAC_IMASK1_P2_TTSCAAM                            (20U)          /* Transmit Timestamp Capture Available A Mask. */
#define BITL_MAC_IMASK1_P2_TTSCAAM                            (1U)           /* Transmit Timestamp Capture Available A Mask. */
#define BITM_MAC_IMASK1_P2_TTSCAAM                            (0X00100000U)  /* Transmit Timestamp Capture Available A Mask. */
#define BITP_MAC_IMASK1_P2_TTSCABM                            (21U)          /* Transmit Timestamp Capture Available B Mask. */
#define BITL_MAC_IMASK1_P2_TTSCABM                            (1U)           /* Transmit Timestamp Capture Available B Mask. */
#define BITM_MAC_IMASK1_P2_TTSCABM                            (0X00200000U)  /* Transmit Timestamp Capture Available B Mask. */
#define BITP_MAC_IMASK1_P2_TTSCACM                            (22U)          /* Transmit Timestamp Capture Available C Mask. */
#define BITL_MAC_IMASK1_P2_TTSCACM                            (1U)           /* Transmit Timestamp Capture Available C Mask. */
#define BITM_MAC_IMASK1_P2_TTSCACM                            (0X00400000U)  /* Transmit Timestamp Capture Available C Mask. */
#define BITP_MAC_IMASK1_P2_RX_IFG_ERR_MASK                    (23U)          /* Mask Bit for RX_IFG_ERR. */
#define BITL_MAC_IMASK1_P2_RX_IFG_ERR_MASK                    (1U)           /* Mask Bit for RX_IFG_ERR. */
#define BITM_MAC_IMASK1_P2_RX_IFG_ERR_MASK                    (0X00800000U)  /* Mask Bit for RX_IFG_ERR. */
#define BITP_MAC_IMASK1_P2_TXFCSEM                            (24U)          /* Transmit Frame Check Sequence Error Mask for P2_TXFCSE. */
#define BITL_MAC_IMASK1_P2_TXFCSEM                            (1U)           /* Transmit Frame Check Sequence Error Mask for P2_TXFCSE. */
#define BITM_MAC_IMASK1_P2_TXFCSEM                            (0X01000000U)  /* Transmit Frame Check Sequence Error Mask for P2_TXFCSE. */
...
#define BITP_MAC_TX_THRESH_P2P_TX_THRESH                      (6U)           /* Port-to-Port Transmit Start Threshold in Cut Through. */
#define BITL_MAC_TX_THRESH_P2P_TX_THRESH                      (6U)           /* Port-to-Port Transmit Start Threshold in Cut Through. */
#define BITM_MAC_TX_THRESH_P2P_TX_THRESH                      (0X00000FC0U)  /* Port-to-Port Transmit Start Threshold in Cut Through. */

/* ----------------------------------------------------------------------------------------------------
          TX_PRI                                                Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_TX_PRI_TX_HOST_PRI                           (0U)           /* Host Transmit Priority. */
#define BITL_MAC_TX_PRI_TX_HOST_PRI                           (3U)           /* Host Transmit Priority. */
#define BITM_MAC_TX_PRI_TX_HOST_PRI                           (0X00000007U)  /* Host Transmit Priority. */

#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H50_P50                   (0X00000000U)  /* 50/50 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H25_P75                   (0X00000001U)  /* 25/75 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H75_P25                   (0X00000002U)  /* 75/25 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H20_P80                   (0X00000003U)  /* 20/80 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H80_P20                   (0X00000004U)  /* 80/20 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H100_P0                   (0X00000005U)  /* 100/0 Host/Port. */
#define ENUM_MAC_TX_PRI_TX_HOST_PRI_H0_P100                   (0X00000006U)  /* 0/100 Host/Port. */
...
#define BITP_MAC_FIFO_CLR_LES_FIFOS_CLR                       (2U)           /* Clear All FIFOs. */
#define BITL_MAC_FIFO_CLR_LES_FIFOS_CLR                       (1U)           /* Clear All FIFOs. */
#define BITM_MAC_FIFO_CLR_LES_FIFOS_CLR                       (0X00000004U)  /* Clear All FIFOs. */
#define BITP_MAC_FIFO_CLR_LES_P2P_FIFOS_CLR                   (3U)           /* Clear the Port to Port FIFOs on LES. */
#define BITL_MAC_FIFO_CLR_LES_P2P_FIFOS_CLR                   (1U)           /* Clear the Port to Port FIFOs on LES. */
#define BITM_MAC_FIFO_CLR_LES_P2P_FIFOS_CLR                   (0X00000008U)  /* Clear the Port to Port FIFOs on LES. */
...
#define BITP_MAC_FIFO_SIZE_P2_RX_LO_SIZE                      (12U)          /* Port 2 Rx Low Priority FIFO Size. */
#define BITL_MAC_FIFO_SIZE_P2_RX_LO_SIZE                      (4U)           /* Port 2 Rx Low Priority FIFO Size. */
#define BITM_MAC_FIFO_SIZE_P2_RX_LO_SIZE                      (0X0000F000U)  /* Port 2 Rx Low Priority FIFO Size. */
#define BITP_MAC_FIFO_SIZE_P2_RX_HI_SIZE                      (16U)          /* Port 2 Rx High Priority FIFO Size. */
#define BITL_MAC_FIFO_SIZE_P2_RX_HI_SIZE                      (4U)           /* Port 2 Rx High Priority FIFO Size. */
#define BITM_MAC_FIFO_SIZE_P2_RX_HI_SIZE                      (0X000F0000U)  /* Port 2 Rx High Priority FIFO Size. */
#define BITP_MAC_FIFO_SIZE_P1_TX_SIZE                         (20U)          /* Port 2 to Port 1 Transmit FIFO Size. */
#define BITL_MAC_FIFO_SIZE_P1_TX_SIZE                         (4U)           /* Port 2 to Port 1 Transmit FIFO Size. */
#define BITM_MAC_FIFO_SIZE_P1_TX_SIZE                         (0X00F00000U)  /* Port 2 to Port 1 Transmit FIFO Size. */
#define BITP_MAC_FIFO_SIZE_P2_TX_SIZE                         (24U)          /* Port 1 to Port 2 Transmit FIFO Size. */
#define BITL_MAC_FIFO_SIZE_P2_TX_SIZE                         (4U)           /* Port 1 to Port 2 Transmit FIFO Size. */
#define BITM_MAC_FIFO_SIZE_P2_TX_SIZE                         (0X0F000000U)  /* Port 1 to Port 2 Transmit FIFO Size. */

#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_0K               (0X00000000U)  /* 0 Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_2K               (0X00000001U)  /* 2k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_4K               (0X00000002U)  /* 4k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_6K               (0X00000003U)  /* 6k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_8K               (0X00000004U)  /* 8k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_10K              (0X00000005U)  /* 10k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_12K              (0X00000006U)  /* 12k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_14K              (0X00000007U)  /* 14k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_16K              (0X00000008U)  /* 16k Byte. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_0K               (0X00000000U)  /* 0 Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_2K               (0X00000001U)  /* 2k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_4K               (0X00000002U)  /* 4k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_6K               (0X00000003U)  /* 6k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_8K               (0X00000004U)  /* 8k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_10K              (0X00000005U)  /* 10k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_12K              (0X00000006U)  /* 12k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_14K              (0X00000007U)  /* 14k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_16K              (0X00000008U)  /* 16k Byte. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_0K            (0X00000000U)  /* 0K Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_2K            (0X00000001U)  /* 2K Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_4K            (0X00000002U)  /* 4k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_6K            (0X00000003U)  /* 6k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_8K            (0X00000004U)  /* 8k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_10K           (0X00000005U)  /* 10k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_12K           (0X00000006U)  /* 12k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_14K           (0X00000007U)  /* 14k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_16K           (0X00000008U)  /* 16k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_0K            (0X00000000U)  /* 0K Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_2K            (0X00000001U)  /* 2K Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_4K            (0X00000002U)  /* 4k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_6K            (0X00000003U)  /* 6k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_8K            (0X00000004U)  /* 8k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_10K           (0X00000005U)  /* 10k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_12K           (0X00000006U)  /* 12k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_14K           (0X00000007U)  /* 14k Bytes. */
#define ENUM_MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_16K           (0X00000008U)  /* 16k Bytes. */
...
#define BITP_MAC_ADDR_FILT_UPR_N__TO_OTHER_PORT               (17U)          /* Forward Frames Matching This MAC Address to the Other Port. */
#define BITL_MAC_ADDR_FILT_UPR_N__TO_OTHER_PORT               (1U)           /* Forward Frames Matching This MAC Address to the Other Port. */
#define BITM_MAC_ADDR_FILT_UPR_N__TO_OTHER_PORT               (0X00020000U)  /* Forward Frames Matching This MAC Address to the Other Port. */
...
#define BITP_MAC_ADDR_FILT_UPR_N__APPLY2PORT2                 (31U)          /* Apply to Port 2. */
#define BITL_MAC_ADDR_FILT_UPR_N__APPLY2PORT2                 (1U)           /* Apply to Port 2. */
#define BITM_MAC_ADDR_FILT_UPR_N__APPLY2PORT2                 (0X80000000U)  /* Apply to Port 2. */

#define ENUM_MAC_ADDR_FILT_UPR_N__APPLY2PORT2_NOTAPPLY        (0X00000000U)  /* Do Not Apply to Port 2. */
#define ENUM_MAC_ADDR_FILT_UPR_N__APPLY2PORT2_APPLY           (0X00000001U)  /* Apply to Port 2. */
...
/* ----------------------------------------------------------------------------------------------------
          P1TOP2_TXSIZE                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P1TOP2_TXSIZE_P1TOP2_TXSIZE                  (0U)           /* Data in P1 TX FIFO. Number of 16-bit Words to Transmit to. */
#define BITL_MAC_P1TOP2_TXSIZE_P1TOP2_TXSIZE                  (14U)          /* Data in P1 TX FIFO. Number of 16-bit Words to Transmit to. */
#define BITM_MAC_P1TOP2_TXSIZE_P1TOP2_TXSIZE                  (0X00003FFFU)  /* Data in P1 TX FIFO. Number of 16-bit Words to Transmit to. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_FSIZE                                           Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_FSIZE_P2_RX_FRM_SIZE                   (0U)           /* Receive Frame Size. */
#define BITL_MAC_P2_RX_FSIZE_P2_RX_FRM_SIZE                   (11U)          /* Receive Frame Size. */
#define BITM_MAC_P2_RX_FSIZE_P2_RX_FRM_SIZE                   (0X000007FFU)  /* Receive Frame Size. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX                                                 Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_P2_RDR                                 (0U)           /* Receive Data Register. */
#define BITL_MAC_P2_RX_P2_RDR                                 (32U)          /* Receive Data Register. */
#define BITM_MAC_P2_RX_P2_RDR                                 (0XFFFFFFFFU)  /* Receive Data Register. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_FRM_CNT                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_FRM_CNT_P2_RX_FRM_CNT                  (0U)           /* Rx Frame Count. */
#define BITL_MAC_P2_RX_FRM_CNT_P2_RX_FRM_CNT                  (32U)          /* Rx Frame Count. */
#define BITM_MAC_P2_RX_FRM_CNT_P2_RX_FRM_CNT                  (0XFFFFFFFFU)  /* Rx Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_BCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_BCAST_CNT_P2_RX_BCAST_CNT              (0U)           /* Rx Broadcast Frame Count. */
#define BITL_MAC_P2_RX_BCAST_CNT_P2_RX_BCAST_CNT              (32U)          /* Rx Broadcast Frame Count. */
#define BITM_MAC_P2_RX_BCAST_CNT_P2_RX_BCAST_CNT              (0XFFFFFFFFU)  /* Rx Broadcast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_MCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_MCAST_CNT_P2_RX_MCAST_CNT              (0U)           /* Rx Multicast Frame Count. */
#define BITL_MAC_P2_RX_MCAST_CNT_P2_RX_MCAST_CNT              (32U)          /* Rx Multicast Frame Count. */
#define BITM_MAC_P2_RX_MCAST_CNT_P2_RX_MCAST_CNT              (0XFFFFFFFFU)  /* Rx Multicast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_UCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_UCAST_CNT_P2_RX_UCAST_CNT              (0U)           /* Rx Unicast Frame Count. */
#define BITL_MAC_P2_RX_UCAST_CNT_P2_RX_UCAST_CNT              (32U)          /* Rx Unicast Frame Count. */
#define BITM_MAC_P2_RX_UCAST_CNT_P2_RX_UCAST_CNT              (0XFFFFFFFFU)  /* Rx Unicast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_CRC_ERR_CNT                                     Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_CRC_ERR_CNT_P2_RX_CRC_ERR_CNT          (0U)           /* Rx CRC Errored Frame Count. */
#define BITL_MAC_P2_RX_CRC_ERR_CNT_P2_RX_CRC_ERR_CNT          (32U)          /* Rx CRC Errored Frame Count. */
#define BITM_MAC_P2_RX_CRC_ERR_CNT_P2_RX_CRC_ERR_CNT          (0XFFFFFFFFU)  /* Rx CRC Errored Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_ALGN_ERR_CNT                                    Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_ALGN_ERR_CNT_P2_RX_ALGN_ERR_CNT        (0U)           /* Rx Align Error Count. */
#define BITL_MAC_P2_RX_ALGN_ERR_CNT_P2_RX_ALGN_ERR_CNT        (32U)          /* Rx Align Error Count. */
#define BITM_MAC_P2_RX_ALGN_ERR_CNT_P2_RX_ALGN_ERR_CNT        (0XFFFFFFFFU)  /* Rx Align Error Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_LS_ERR_CNT                                      Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_LS_ERR_CNT_P2_RX_LS_ERR_CNT            (0U)           /* Rx Long/Short Frame Error Count. */
#define BITL_MAC_P2_RX_LS_ERR_CNT_P2_RX_LS_ERR_CNT            (32U)          /* Rx Long/Short Frame Error Count. */
#define BITM_MAC_P2_RX_LS_ERR_CNT_P2_RX_LS_ERR_CNT            (0XFFFFFFFFU)  /* Rx Long/Short Frame Error Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_PHY_ERR_CNT                                     Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_PHY_ERR_CNT_P2_RX_PHY_ERR_CNT          (0U)           /* Rx PHY Error Count. */
#define BITL_MAC_P2_RX_PHY_ERR_CNT_P2_RX_PHY_ERR_CNT          (32U)          /* Rx PHY Error Count. */
#define BITM_MAC_P2_RX_PHY_ERR_CNT_P2_RX_PHY_ERR_CNT          (0XFFFFFFFFU)  /* Rx PHY Error Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_TX_FRM_CNT                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TX_FRM_CNT_P2_TX_FRM_CNT                  (0U)           /* Tx Frame Count. */
#define BITL_MAC_P2_TX_FRM_CNT_P2_TX_FRM_CNT                  (32U)          /* Tx Frame Count. */
#define BITM_MAC_P2_TX_FRM_CNT_P2_TX_FRM_CNT                  (0XFFFFFFFFU)  /* Tx Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_TX_BCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TX_BCAST_CNT_P2_TX_BCAST_CNT              (0U)           /* Tx Broadcast Frame Count. */
#define BITL_MAC_P2_TX_BCAST_CNT_P2_TX_BCAST_CNT              (32U)          /* Tx Broadcast Frame Count. */
#define BITM_MAC_P2_TX_BCAST_CNT_P2_TX_BCAST_CNT              (0XFFFFFFFFU)  /* Tx Broadcast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_TX_MCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TX_MCAST_CNT_P2_TX_MCAST_CNT              (0U)           /* Tx Multicast Frame Count. */
#define BITL_MAC_P2_TX_MCAST_CNT_P2_TX_MCAST_CNT              (32U)          /* Tx Multicast Frame Count. */
#define BITM_MAC_P2_TX_MCAST_CNT_P2_TX_MCAST_CNT              (0XFFFFFFFFU)  /* Tx Multicast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_TX_UCAST_CNT                                       Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TX_UCAST_CNT_P2_TX_UCAST_CNT              (0U)           /* Tx Unicast Frame Count. */
#define BITL_MAC_P2_TX_UCAST_CNT_P2_TX_UCAST_CNT              (32U)          /* Tx Unicast Frame Count. */
#define BITM_MAC_P2_TX_UCAST_CNT_P2_TX_UCAST_CNT              (0XFFFFFFFFU)  /* Tx Unicast Frame Count. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_DROP_FULL_CNT                                   Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_DROP_FULL_CNT_P2_RX_DROP_FULL_CNT      (0U)           /* Rx Frames Dropped Due to FIFO Full. */
#define BITL_MAC_P2_RX_DROP_FULL_CNT_P2_RX_DROP_FULL_CNT      (32U)          /* Rx Frames Dropped Due to FIFO Full. */
#define BITM_MAC_P2_RX_DROP_FULL_CNT_P2_RX_DROP_FULL_CNT      (0XFFFFFFFFU)  /* Rx Frames Dropped Due to FIFO Full. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_DROP_FILT_CNT                                   Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_DROP_FILT_CNT_P2_RX_DROP_FILT_CNT      (0U)           /* Rx Frames Dropped Due to Filtering. */
#define BITL_MAC_P2_RX_DROP_FILT_CNT_P2_RX_DROP_FILT_CNT      (32U)          /* Rx Frames Dropped Due to Filtering. */
#define BITM_MAC_P2_RX_DROP_FILT_CNT_P2_RX_DROP_FILT_CNT      (0XFFFFFFFFU)  /* Rx Frames Dropped Due to Filtering. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_IFG_ERR_CNT                                     Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_IFG_ERR_CNT_P2_RX_IFG_ERR_CNT          (0U)           /* IFG Error Counter for Port 2 Received Frames. */
#define BITL_MAC_P2_RX_IFG_ERR_CNT_P2_RX_IFG_ERR_CNT          (32U)          /* IFG Error Counter for Port 2 Received Frames. */
#define BITM_MAC_P2_RX_IFG_ERR_CNT_P2_RX_IFG_ERR_CNT          (0XFFFFFFFFU)  /* IFG Error Counter for Port 2 Received Frames. */

/* ----------------------------------------------------------------------------------------------------
          P2_TX_IFG                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TX_IFG_P2_TX_IFG                          (0U)           /* Inter Frame Gap. */
#define BITL_MAC_P2_TX_IFG_P2_TX_IFG                          (8U)           /* Inter Frame Gap. */
#define BITM_MAC_P2_TX_IFG_P2_TX_IFG                          (0X000000FFU)  /* Inter Frame Gap. */

/* ----------------------------------------------------------------------------------------------------
          P2_LOOP                                               Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_LOOP_P2_LOOPBACK_EN                       (0U)           /* MAC Loopback. */
#define BITL_MAC_P2_LOOP_P2_LOOPBACK_EN                       (1U)           /* MAC Loopback. */
#define BITM_MAC_P2_LOOP_P2_LOOPBACK_EN                       (0X00000001U)  /* MAC Loopback. */

#define ENUM_MAC_P2_LOOP_P2_LOOPBACK_EN_LOOPB_DIS             (0X00000000U)  /* Normal Operation - Loopback Disabled. */
#define ENUM_MAC_P2_LOOP_P2_LOOPBACK_EN_LOOPB_EN              (0X00000001U)  /* Loopback Enabled. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_CRC_EN                                          Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_CRC_EN_P2_CRC_CHK_EN                   (0U)           /* CRC Check Enable on Receive. */
#define BITL_MAC_P2_RX_CRC_EN_P2_CRC_CHK_EN                   (1U)           /* CRC Check Enable on Receive. */
#define BITM_MAC_P2_RX_CRC_EN_P2_CRC_CHK_EN                   (0X00000001U)  /* CRC Check Enable on Receive. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_IFG                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_IFG_P2_RX_IFG                          (0U)           /* Inter Frame Gap. */
#define BITL_MAC_P2_RX_IFG_P2_RX_IFG                          (6U)           /* Inter Frame Gap. */
#define BITM_MAC_P2_RX_IFG_P2_RX_IFG                          (0X0000003FU)  /* Inter Frame Gap. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_MAX_LEN                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_MAX_LEN_P2_MAX_FRM_LEN                 (0U)           /* Max Frame Length on Receive in Bytes. */
#define BITL_MAC_P2_RX_MAX_LEN_P2_MAX_FRM_LEN                 (16U)          /* Max Frame Length on Receive in Bytes. */
#define BITM_MAC_P2_RX_MAX_LEN_P2_MAX_FRM_LEN                 (0X0000FFFFU)  /* Max Frame Length on Receive in Bytes. */

/* ----------------------------------------------------------------------------------------------------
          P2_RX_MIN_LEN                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_RX_MIN_LEN_P2_MIN_FRM_LEN                 (0U)           /* Min Frame Length on Receive in Bytes. */
#define BITL_MAC_P2_RX_MIN_LEN_P2_MIN_FRM_LEN                 (16U)          /* Min Frame Length on Receive in Bytes. */
#define BITM_MAC_P2_RX_MIN_LEN_P2_MIN_FRM_LEN                 (0X0000FFFFU)  /* Min Frame Length on Receive in Bytes. */

/* ----------------------------------------------------------------------------------------------------
          P2_LO_RFC                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_LO_RFC_P2_LO_RFC                          (0U)           /* Receive Frame Count for the Low Priority FIFO. */
#define BITL_MAC_P2_LO_RFC_P2_LO_RFC                          (9U)           /* Receive Frame Count for the Low Priority FIFO. */
#define BITM_MAC_P2_LO_RFC_P2_LO_RFC                          (0X000001FFU)  /* Receive Frame Count for the Low Priority FIFO. */

/* ----------------------------------------------------------------------------------------------------
          P2_HI_RFC                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_HI_RFC_P2_HI_RFC                          (0U)           /* Receive Frame Count for the High Priority FIFO. */
#define BITL_MAC_P2_HI_RFC_P2_HI_RFC                          (9U)           /* Receive Frame Count for the High Priority FIFO. */
#define BITM_MAC_P2_HI_RFC_P2_HI_RFC                          (0X000001FFU)  /* Receive Frame Count for the High Priority FIFO. */

/* ----------------------------------------------------------------------------------------------------
          P2_LO_RXSIZE                                          Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_LO_RXSIZE_P2_LO_RXSIZE                    (0U)           /* Data in the Rx FIFO. Number of Half Words(16 Bit). */
#define BITL_MAC_P2_LO_RXSIZE_P2_LO_RXSIZE                    (14U)          /* Data in the Rx FIFO. Number of Half Words(16 Bit). */
#define BITM_MAC_P2_LO_RXSIZE_P2_LO_RXSIZE                    (0X00003FFFU)  /* Data in the Rx FIFO. Number of Half Words(16 Bit). */

/* ----------------------------------------------------------------------------------------------------
          P2_HI_RXSIZE                                          Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_HI_RXSIZE_P2_HI_RXSIZE                    (0U)           /* Data in the Rx FIFO. Number of Half Words(16 Bit). */
#define BITL_MAC_P2_HI_RXSIZE_P2_HI_RXSIZE                    (14U)          /* Data in the Rx FIFO. Number of Half Words(16 Bit). */
#define BITM_MAC_P2_HI_RXSIZE_P2_HI_RXSIZE                    (0X00003FFFU)  /* Data in the Rx FIFO. Number of Half Words(16 Bit). */

/* ----------------------------------------------------------------------------------------------------
          P2TOP1_TXSIZE                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2TOP1_TXSIZE_P2TOP1_TXSIZE                  (0U)           /* Data in P2 TX FIFO. Number of 16-bit Words to Transmit to. */
#define BITL_MAC_P2TOP1_TXSIZE_P2TOP1_TXSIZE                  (14U)          /* Data in P2 TX FIFO. Number of 16-bit Words to Transmit to. */
#define BITM_MAC_P2TOP1_TXSIZE_P2TOP1_TXSIZE                  (0X00003FFFU)  /* Data in P2 TX FIFO. Number of 16-bit Words to Transmit to. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCAH                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCAH_P2_TTSCH_A                         (0U)           /* P2 Transmit Timestamp A Bits 63-32. */
#define BITL_MAC_P2_TTSCAH_P2_TTSCH_A                         (32U)          /* P2 Transmit Timestamp A Bits 63-32. */
#define BITM_MAC_P2_TTSCAH_P2_TTSCH_A                         (0XFFFFFFFFU)  /* P2 Transmit Timestamp A Bits 63-32. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCAL                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCAL_P2_TTSCL_A                         (0U)           /* P2 Transmit Timestamp A Bits 31-0. */
#define BITL_MAC_P2_TTSCAL_P2_TTSCL_A                         (32U)          /* P2 Transmit Timestamp A Bits 31-0. */
#define BITM_MAC_P2_TTSCAL_P2_TTSCL_A                         (0XFFFFFFFFU)  /* P2 Transmit Timestamp A Bits 31-0. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCBH                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCBH_P2_TTSCH_B                         (0U)           /* P2 Transmit Timestamp B Bits 63-32. */
#define BITL_MAC_P2_TTSCBH_P2_TTSCH_B                         (32U)          /* P2 Transmit Timestamp B Bits 63-32. */
#define BITM_MAC_P2_TTSCBH_P2_TTSCH_B                         (0XFFFFFFFFU)  /* P2 Transmit Timestamp B Bits 63-32. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCBL                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCBL_P2_TTSCL_B                         (0U)           /* P2 Transmit Timestamp B Bits 31-0. */
#define BITL_MAC_P2_TTSCBL_P2_TTSCL_B                         (32U)          /* P2 Transmit Timestamp B Bits 31-0. */
#define BITM_MAC_P2_TTSCBL_P2_TTSCL_B                         (0XFFFFFFFFU)  /* P2 Transmit Timestamp B Bits 31-0. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCCH                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCCH_P2_TTSCH_C                         (0U)           /* P2 Transmit Timestamp C Bits 63-32. */
#define BITL_MAC_P2_TTSCCH_P2_TTSCH_C                         (32U)          /* P2 Transmit Timestamp C Bits 63-32. */
#define BITM_MAC_P2_TTSCCH_P2_TTSCH_C                         (0XFFFFFFFFU)  /* P2 Transmit Timestamp C Bits 63-32. */

/* ----------------------------------------------------------------------------------------------------
          P2_TTSCCL                                             Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_MAC_P2_TTSCCL_P2_TTSCL_C                         (0U)           /* P2 Transmit Timestamp C Bits 31-0. */
#define BITL_MAC_P2_TTSCCL_P2_TTSCL_C                         (32U)          /* P2 Transmit Timestamp C Bits 31-0. */
