 ...
 *                  - #ADI_HAL_ERROR        Error encountered during function execution.
 *
 * @details         Enters Critical Section, stores local key to allow exit
 *
 * @sa              HAL_ExitCriticalSection()
 */
 ...
 *                  - #ADI_HAL_ERROR        Error encountered during function execution.
 *
 * @details         Exits Critical Section using locally stored key
 *
 * @sa              HAL_EnterCriticalSection()
 */
