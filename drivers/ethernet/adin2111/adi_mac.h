...
#elif defined(CONFIG_ETH_ADIN2111)
...
typedef enum
{
    ADI_MAC_RX_FIFO_PRIO_LOW        = 0,        /*!< Low priority. */
    ADI_MAC_RX_FIFO_PRIO_HIGH,                  /*!< High priority. */
...
/*!
 * @brief Forwarding mode definitions.
 */
typedef struct
{
...
typedef enum
{
    ADI_MAC_RX_FIFO_SIZE_0K  = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_0K),     /*!< 0kB Rx FIFO.   */
    ADI_MAC_RX_FIFO_SIZE_2K  = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_2K),     /*!< 2kB Rx FIFO.   */
    ADI_MAC_RX_FIFO_SIZE_4K  = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_4K),     /*!< 4kB Rx FIFO.   */
    ADI_MAC_RX_FIFO_SIZE_6K  = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_6K),     /*!< 6kB Rx FIFO.   */
    ADI_MAC_RX_FIFO_SIZE_8K  = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_8K),     /*!< 8kB Rx FIFO.   */
    ADI_MAC_RX_FIFO_SIZE_10K = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_10K),    /*!< 10kB Rx FIFO.  */
    ADI_MAC_RX_FIFO_SIZE_12K = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_12K),    /*!< 12kB Rx FIFO.  */
    ADI_MAC_RX_FIFO_SIZE_14K = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_14K),    /*!< 14kB Rx FIFO.  */
    ADI_MAC_RX_FIFO_SIZE_16K = (MAC_FIFO_SIZE_P1_RX_HI_SIZE_RXSIZE_16K),    /*!< 16kB Rx FIFO.  */
...
typedef enum
{
    ...
    ADI_MAC_HTX_FIFO_SIZE_8K  = (MAC_FIFO_SIZE_HTX_SIZE_TXSIZE_8K),     /*!< 8kB Host Tx FIFO.   */
    ADI_MAC_HTX_FIFO_SIZE_10K = (MAC_FIFO_SIZE_HTX_SIZE_TXSIZE_10K),    /*!< 10kB Host Tx FIFO.  */
    ADI_MAC_HTX_FIFO_SIZE_12K = (MAC_FIFO_SIZE_HTX_SIZE_TXSIZE_12K),    /*!< 12kB Host Tx FIFO.  */
    ADI_MAC_HTX_FIFO_SIZE_14K = (MAC_FIFO_SIZE_HTX_SIZE_TXSIZE_14K),    /*!< 14kB Host Tx FIFO.  */
...
typedef enum
{
    ADI_MAC_PTX_FIFO_SIZE_0K  = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_0K),   /*!< 0kB Port Tx FIFO.      */
    ADI_MAC_PTX_FIFO_SIZE_2K  = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_2K),   /*!< 2kB Port Tx FIFO.      */
    ADI_MAC_PTX_FIFO_SIZE_4K  = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_4K),   /*!< 4kB Port Tx FIFO.      */
    ADI_MAC_PTX_FIFO_SIZE_6K  = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_6K),   /*!< 6kB Port Tx FIFO.      */
    ADI_MAC_PTX_FIFO_SIZE_8K  = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_8K),   /*!< 8kB Port Tx FIFO.      */
    ADI_MAC_PTX_FIFO_SIZE_10K = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_10K),  /*!< 10kB Port Tx FIFO.     */
    ADI_MAC_PTX_FIFO_SIZE_12K = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_12K),  /*!< 12kB Port Tx FIFO.     */
    ADI_MAC_PTX_FIFO_SIZE_14K = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_14K),  /*!< 14kB Port Tx FIFO.     */
    ADI_MAC_PTX_FIFO_SIZE_16K = (MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_16K),  /*!< 16kB Port Tx FIFO.     */
