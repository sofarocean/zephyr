...
/*! ========================================================================
 *  \enum ADI_MAC_CONFIG2_RX_RD_ORDER
 *  \brief Rx Ports Read Order for the Open Alliance Data Protocol.
 *  ======================================================================== */
typedef enum
{
     MAC_CONFIG2_RX_RD_ORDER_FILL_LVL = 0,    /**< Fill Level. */
     MAC_CONFIG2_RX_RD_ORDER_PING_PONG = 1     /**< Ping Pong. */
}  ADI_MAC_CONFIG2_RX_RD_ORDER;
...
typedef struct _ADI_MAC_CONFIG2_t {
    union {
        struct {
             ...
             uint32_t PORT_CUT_THRU_EN : 1; /**< Enable Cut Through from Port to Port. */
             uint32_t P2_FWD_UNK2HOST  : 1; /**< Forward Frames Not Matching Any MAC Address to the Host. */
             uint32_t P1_FWD_UNK2P2    : 1; /**< Forward Frames from Port1 Not Matching a MAC Addr to Port2. */
             uint32_t P2_FWD_UNK2P1    : 1; /**< Forward Frames from Port2 Not Matching a MAC Addr to Port1. */
             uint32_t RX_RD_ORDER      : 1; /**< Rx Ports Read Order for the Open Alliance Data Protocol. */
             uint32_t P2_RCV_IFG_ERR_FRM : 1; /**< Admit Frames with IFG Errors on P2. */
...
typedef struct _ADI_MAC_STATUS1_t {
    union {
        struct {
             ...
             uint32_t RESERVED13       : 4; /**< Reserved */
             uint32_t P2_RX_RDY        : 1; /**< Port2 Rx FIFO Contains Data. */
             uint32_t P2_RX_RDY_HI     : 1; /**< Port2 Rx Ready High Priority. */
             uint32_t P2_PHYINT        : 1; /**< PHY Interrupt for Port2. */
             uint32_t P2_TTSCAA        : 1; /**< Transmit Timestamp Capture Available A. */
             uint32_t P2_TTSCAB        : 1; /**< Transmit Timestamp Capture Available B. */
             uint32_t P2_TTSCAC        : 1; /**< Transmit Timestamp Capture Available C. */
             uint32_t P2_RX_IFG_ERR    : 1; /**< Rx MAC Inter Frame Gap Error. */
             uint32_t P2_TXFCSE        : 1; /**< CRC Mismatch on a Tx Frame on P2. */
...
typedef struct _ADI_MAC_IMASK1_t {
    union {
        struct {
             ...
             uint32_t RESERVED13       : 4; /**< Reserved */
             uint32_t P2_RX_RDY_MASK   : 1; /**< Mask Bit for P2_RX_RDY. */
             uint32_t RESERVED18       : 1; /**< Reserved */
             uint32_t P2_PHYINT_MASK   : 1; /**< Mask Bit for P2_PHYINT. */
             uint32_t P2_TTSCAAM       : 1; /**< Transmit Timestamp Capture Available A Mask. */
             uint32_t P2_TTSCABM       : 1; /**< Transmit Timestamp Capture Available B Mask. */
             uint32_t P2_TTSCACM       : 1; /**< Transmit Timestamp Capture Available C Mask. */
             uint32_t P2_RX_IFG_ERR_MASK : 1; /**< Mask Bit for RX_IFG_ERR. */
             uint32_t P2_TXFCSEM       : 1; /**< Transmit Frame Check Sequence Error Mask for P2_TXFCSE. */
             uint32_t RESERVED25       : 7; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
typedef struct _ADI_MAC_TX_THRESH_t {
    union {
        struct {
             ...
             uint32_t P2P_TX_THRESH    : 6; /**< Port-to-Port Transmit Start Threshold in Cut Through. */
...
/** @defgroup TX_PRI LES Tx Priority Register. (TX_PRI) Register
 *  LES Tx Priority Register. (TX_PRI) Register
 *  @{
 */

/*! ========================================================================
 *  \enum ADI_MAC_TX_PRI_TX_HOST_PRI
 *  \brief Host Transmit Priority.
 *  ======================================================================== */
typedef enum
{
     MAC_TX_PRI_TX_HOST_PRI_H50_P50   = 0,    /**< 50/50 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H25_P75   = 1,    /**< 25/75 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H75_P25   = 2,    /**< 75/25 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H20_P80   = 3,    /**< 20/80 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H80_P20   = 4,    /**< 80/20 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H100_P0   = 5,    /**< 100/0 Host/Port. */
     MAC_TX_PRI_TX_HOST_PRI_H0_P100   = 6     /**< 0/100 Host/Port. */
}  ADI_MAC_TX_PRI_TX_HOST_PRI;

/*! ========================================================================
 *  \struct ADI_MAC_TX_PRI_t
 *  \brief LES Tx Priority Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_TX_PRI_t {
    union {
        struct {
             uint32_t TX_HOST_PRI      : 3; /**< Host Transmit Priority. */
...
typedef struct _ADI_MAC_FIFO_CLR_t {
    union {
        struct {
             ...
             uint32_t LES_FIFOS_CLR    : 1; /**< Clear All FIFOs. */
             uint32_t LES_P2P_FIFOS_CLR : 1; /**< Clear the Port to Port FIFOs on LES. */
...
/*! ========================================================================
 *  \enum ADI_MAC_FIFO_SIZE_P2_RX_LO_SIZE
 *  \brief Port 2 Rx Low Priority FIFO Size.
 *  ======================================================================== */
typedef enum
{
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_0K = 0,    /**< 0K Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_2K = 1,    /**< 2K Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_4K = 2,    /**< 4k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_6K = 3,    /**< 6k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_8K = 4,    /**< 8k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_10K = 5,    /**< 10k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_12K = 6,    /**< 12k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_14K = 7,    /**< 14k Bytes. */
     MAC_FIFO_SIZE_P2_RX_LO_SIZE_RXSIZE_16K = 8     /**< 16k Bytes. */
}  ADI_MAC_FIFO_SIZE_P2_RX_LO_SIZE;

/*! ========================================================================
 *  \enum ADI_MAC_FIFO_SIZE_P2_RX_HI_SIZE
 *  \brief Port 2 Rx High Priority FIFO Size.
 *  ======================================================================== */
typedef enum
{
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_0K = 0,    /**< 0K Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_2K = 1,    /**< 2K Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_4K = 2,    /**< 4k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_6K = 3,    /**< 6k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_8K = 4,    /**< 8k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_10K = 5,    /**< 10k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_12K = 6,    /**< 12k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_14K = 7,    /**< 14k Bytes. */
     MAC_FIFO_SIZE_P2_RX_HI_SIZE_RXSIZE_16K = 8     /**< 16k Bytes. */
}  ADI_MAC_FIFO_SIZE_P2_RX_HI_SIZE;

/*! ========================================================================
 *  \enum ADI_MAC_FIFO_SIZE_P1_TX_SIZE
 *  \brief Port 2 to Port 1 Transmit FIFO Size.
 *  ======================================================================== */
typedef enum
{
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_0K = 0,    /**< 0 Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_2K = 1,    /**< 2k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_4K = 2,    /**< 4k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_6K = 3,    /**< 6k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_8K = 4,    /**< 8k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_10K = 5,    /**< 10k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_12K = 6,    /**< 12k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_14K = 7,    /**< 14k Bytes. */
     MAC_FIFO_SIZE_P1_TX_SIZE_TXSIZE_16K = 8     /**< 16k Byte. */
}  ADI_MAC_FIFO_SIZE_P1_TX_SIZE;

/*! ========================================================================
 *  \enum ADI_MAC_FIFO_SIZE_P2_TX_SIZE
 *  \brief Port 1 to Port 2 Transmit FIFO Size.
 *  ======================================================================== */
typedef enum
{
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_0K = 0,    /**< 0 Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_2K = 1,    /**< 2k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_4K = 2,    /**< 4k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_6K = 3,    /**< 6k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_8K = 4,    /**< 8k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_10K = 5,    /**< 10k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_12K = 6,    /**< 12k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_14K = 7,    /**< 14k Bytes. */
     MAC_FIFO_SIZE_P2_TX_SIZE_TXSIZE_16K = 8     /**< 16k Byte. */
}  ADI_MAC_FIFO_SIZE_P2_TX_SIZE;
...
typedef struct _ADI_MAC_FIFO_SIZE_t {
    union {
        struct {
             ...
             uint32_t P2_RX_LO_SIZE    : 4; /**< Port 2 Rx Low Priority FIFO Size. */
             uint32_t P2_RX_HI_SIZE    : 4; /**< Port 2 Rx High Priority FIFO Size. */
             uint32_t P1_TX_SIZE       : 4; /**< Port 2 to Port 1 Transmit FIFO Size. */
             uint32_t P2_TX_SIZE       : 4; /**< Port 1 to Port 2 Transmit FIFO Size. */
...
/*! ========================================================================
 *  \enum ADI_MAC_ADDR_FILT_UPR_0__APPLY2PORT2
 *  \brief Apply to Port 2.
 *  ======================================================================== */
typedef enum
{
     MAC_ADDR_FILT_UPR_0__APPLY2PORT2_NOTAPPLY = 0,    /**< Do Not Apply to Port 2. */
     MAC_ADDR_FILT_UPR_0__APPLY2PORT2_APPLY = 1     /**< Apply to Port 2. */
}  ADI_MAC_ADDR_FILT_UPR_0__APPLY2PORT2;
...
typedef struct _ADI_MAC_ADDR_FILT_UPR_0__t {
    union {
        struct {
             ...
             uint32_t TO_OTHER_PORT    : 1; /**< Forward Frames Matching This MAC Address to the Other Port. */
             uint32_t RESERVED18       : 1; /**< Reserved */
             uint32_t HOST_PRI         : 1; /**< Host Rx Port Priority. */
             uint32_t RESERVED20       : 10; /**< Reserved */
             uint32_t APPLY2PORT1      : 1; /**< Apply to Port 1. */
             uint32_t APPLY2PORT2      : 1; /**< Apply to Port 2. */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P1TOP2_TXSIZE P1 to P2 TX Size. (P1TOP2_TXSIZE) Register
 *  P1 to P2 TX Size. (P1TOP2_TXSIZE) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P1TOP2_TXSIZE_t
 *  \brief P1 to P2 TX Size.
 *  ======================================================================== */
typedef struct _ADI_MAC_P1TOP2_TXSIZE_t {
    union {
        struct {
             uint32_t P1TOP2_TXSIZE    : 14; /**< Data in P1 TX FIFO. Number of 16-bit Words to Transmit to. */
             uint32_t RESERVED14       : 18; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P1TOP2_TXSIZE_t;

/*@}*/

/** @defgroup P2_RX_FSIZE P2 MAC Rx Frame Size Register. (P2_RX_FSIZE) Register
 *  P2 MAC Rx Frame Size Register. (P2_RX_FSIZE) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_FSIZE_t
 *  \brief P2 MAC Rx Frame Size Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_FSIZE_t {
    union {
        struct {
             uint32_t P2_RX_FRM_SIZE   : 11; /**< Receive Frame Size. */
             uint32_t RESERVED11       : 21; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_FSIZE_t;

/*@}*/

/** @defgroup P2_RX P2 MAC Receive Register. (P2_RX) Register
 *  P2 MAC Receive Register. (P2_RX) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_t
 *  \brief P2 MAC Receive Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_t {
    union {
        struct {
             uint32_t P2_RDR           : 32; /**< Receive Data Register. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_t;
...
/** @defgroup P2_RX_FRM_CNT P2 Rx Frame Count Register. (P2_RX_FRM_CNT) Register
 *  P2 Rx Frame Count Register. (P2_RX_FRM_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_FRM_CNT_t
 *  \brief P2 Rx Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_FRM_CNT_t {
    union {
        struct {
             uint32_t P2_RX_FRM_CNT    : 32; /**< Rx Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_FRM_CNT_t;

/*@}*/

/** @defgroup P2_RX_BCAST_CNT P2 Rx Broadcast Frame Count Register. (P2_RX_BCAST_CNT) Register
 *  P2 Rx Broadcast Frame Count Register. (P2_RX_BCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_BCAST_CNT_t
 *  \brief P2 Rx Broadcast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_BCAST_CNT_t {
    union {
        struct {
             uint32_t P2_RX_BCAST_CNT  : 32; /**< Rx Broadcast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_BCAST_CNT_t;

/*@}*/

/** @defgroup P2_RX_MCAST_CNT P2 Rx Multicast Frame Count Register. (P2_RX_MCAST_CNT) Register
 *  P2 Rx Multicast Frame Count Register. (P2_RX_MCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_MCAST_CNT_t
 *  \brief P2 Rx Multicast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_MCAST_CNT_t {
    union {
        struct {
             uint32_t P2_RX_MCAST_CNT  : 32; /**< Rx Multicast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_MCAST_CNT_t;

/*@}*/

/** @defgroup P2_RX_UCAST_CNT P2 Rx Unicast Frame Count Register. (P2_RX_UCAST_CNT) Register
 *  P2 Rx Unicast Frame Count Register. (P2_RX_UCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_UCAST_CNT_t
 *  \brief P2 Rx Unicast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_UCAST_CNT_t {
    union {
        struct {
             uint32_t P2_RX_UCAST_CNT  : 32; /**< Rx Unicast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_UCAST_CNT_t;

/*@}*/

/** @defgroup P2_RX_CRC_ERR_CNT P2 Rx CRC Errored Frame Count Register. (P2_RX_CRC_ERR_CNT) Register
 *  P2 Rx CRC Errored Frame Count Register. (P2_RX_CRC_ERR_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_CRC_ERR_CNT_t
 *  \brief P2 Rx CRC Errored Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_CRC_ERR_CNT_t {
    union {
        struct {
             uint32_t P2_RX_CRC_ERR_CNT : 32; /**< Rx CRC Errored Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_CRC_ERR_CNT_t;

/*@}*/

/** @defgroup P2_RX_ALGN_ERR_CNT P2 Rx Align Error Count Register. (P2_RX_ALGN_ERR_CNT) Register
 *  P2 Rx Align Error Count Register. (P2_RX_ALGN_ERR_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_ALGN_ERR_CNT_t
 *  \brief P2 Rx Align Error Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_ALGN_ERR_CNT_t {
    union {
        struct {
             uint32_t P2_RX_ALGN_ERR_CNT : 32; /**< Rx Align Error Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_ALGN_ERR_CNT_t;

/*@}*/

/** @defgroup P2_RX_LS_ERR_CNT P2 Rx Long/Short Frame Error Count Register. (P2_RX_LS_ERR_CNT) Register
 *  P2 Rx Long/Short Frame Error Count Register. (P2_RX_LS_ERR_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_LS_ERR_CNT_t
 *  \brief P2 Rx Long/Short Frame Error Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_LS_ERR_CNT_t {
    union {
        struct {
             uint32_t P2_RX_LS_ERR_CNT : 32; /**< Rx Long/Short Frame Error Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_LS_ERR_CNT_t;

/*@}*/

/** @defgroup P2_RX_PHY_ERR_CNT P2 Rx PHY Error Count Register. (P2_RX_PHY_ERR_CNT) Register
 *  P2 Rx PHY Error Count Register. (P2_RX_PHY_ERR_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_PHY_ERR_CNT_t
 *  \brief P2 Rx PHY Error Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_PHY_ERR_CNT_t {
    union {
        struct {
             uint32_t P2_RX_PHY_ERR_CNT : 32; /**< Rx PHY Error Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_PHY_ERR_CNT_t;

/*@}*/

/** @defgroup P2_TX_FRM_CNT P2 Tx Frame Count Register. (P2_TX_FRM_CNT) Register
 *  P2 Tx Frame Count Register. (P2_TX_FRM_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TX_FRM_CNT_t
 *  \brief P2 Tx Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TX_FRM_CNT_t {
    union {
        struct {
             uint32_t P2_TX_FRM_CNT    : 32; /**< Tx Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TX_FRM_CNT_t;

/*@}*/

/** @defgroup P2_TX_BCAST_CNT P2 Tx Broadcast Frame Count Register. (P2_TX_BCAST_CNT) Register
 *  P2 Tx Broadcast Frame Count Register. (P2_TX_BCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TX_BCAST_CNT_t
 *  \brief P2 Tx Broadcast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TX_BCAST_CNT_t {
    union {
        struct {
             uint32_t P2_TX_BCAST_CNT  : 32; /**< Tx Broadcast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TX_BCAST_CNT_t;

/*@}*/

/** @defgroup P2_TX_MCAST_CNT P2 Tx Multicast Frame Count Register. (P2_TX_MCAST_CNT) Register
 *  P2 Tx Multicast Frame Count Register. (P2_TX_MCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TX_MCAST_CNT_t
 *  \brief P2 Tx Multicast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TX_MCAST_CNT_t {
    union {
        struct {
             uint32_t P2_TX_MCAST_CNT  : 32; /**< Tx Multicast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TX_MCAST_CNT_t;

/*@}*/

/** @defgroup P2_TX_UCAST_CNT P2 Tx Unicast Frame Count Register. (P2_TX_UCAST_CNT) Register
 *  P2 Tx Unicast Frame Count Register. (P2_TX_UCAST_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TX_UCAST_CNT_t
 *  \brief P2 Tx Unicast Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TX_UCAST_CNT_t {
    union {
        struct {
             uint32_t P2_TX_UCAST_CNT  : 32; /**< Tx Unicast Frame Count. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TX_UCAST_CNT_t;

/*@}*/

/** @defgroup P2_RX_DROP_FULL_CNT P2 Rx Frames Dropped Due to FIFO Full Register. (P2_RX_DROP_FULL_CNT) Register
 *  P2 Rx Frames Dropped Due to FIFO Full Register. (P2_RX_DROP_FULL_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_DROP_FULL_CNT_t
 *  \brief P2 Rx Frames Dropped Due to FIFO Full Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_DROP_FULL_CNT_t {
    union {
        struct {
             uint32_t P2_RX_DROP_FULL_CNT : 32; /**< Rx Frames Dropped Due to FIFO Full. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_DROP_FULL_CNT_t;

/*@}*/

/** @defgroup P2_RX_DROP_FILT_CNT P2 Rx Frames Dropped Due to Filtering Register. (P2_RX_DROP_FILT_CNT) Register
 *  P2 Rx Frames Dropped Due to Filtering Register. (P2_RX_DROP_FILT_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_DROP_FILT_CNT_t
 *  \brief P2 Rx Frames Dropped Due to Filtering Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_DROP_FILT_CNT_t {
    union {
        struct {
             uint32_t P2_RX_DROP_FILT_CNT : 32; /**< Rx Frames Dropped Due to Filtering. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_DROP_FILT_CNT_t;

/*@}*/

/** @defgroup P2_RX_IFG_ERR_CNT Frames Received on Port 2 with IFG Errors. (P2_RX_IFG_ERR_CNT) Register
 *  Frames Received on Port 2 with IFG Errors. (P2_RX_IFG_ERR_CNT) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_IFG_ERR_CNT_t
 *  \brief Frames Received on Port 2 with IFG Errors.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_IFG_ERR_CNT_t {
    union {
        struct {
             uint32_t P2_RX_IFG_ERR_CNT : 32; /**< IFG Error Counter for Port 2 Received Frames. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_IFG_ERR_CNT_t;

/*@}*/

/** @defgroup P2_TX_IFG P2 Transmit Inter Frame Gap Register. (P2_TX_IFG) Register
 *  P2 Transmit Inter Frame Gap Register. (P2_TX_IFG) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TX_IFG_t
 *  \brief P2 Transmit Inter Frame Gap Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TX_IFG_t {
    union {
        struct {
             uint32_t P2_TX_IFG        : 8; /**< Inter Frame Gap. */
             uint32_t RESERVED8        : 24; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P2_LOOP P2 MAC Loopback Enable Register. (P2_LOOP) Register
 *  P2 MAC Loopback Enable Register. (P2_LOOP) Register
 *  @{
 */

/*! ========================================================================
 *  \enum ADI_MAC_P2_LOOP_P2_LOOPBACK_EN
 *  \brief MAC Loopback.
 *  ======================================================================== */
typedef enum
{
     MAC_P2_LOOP_P2_LOOPBACK_EN_LOOPB_DIS = 0,    /**< Normal Operation - Loopback Disabled. */
     MAC_P2_LOOP_P2_LOOPBACK_EN_LOOPB_EN = 1     /**< Loopback Enabled. */
}  ADI_MAC_P2_LOOP_P2_LOOPBACK_EN;

/*! ========================================================================
 *  \struct ADI_MAC_P2_LOOP_t
 *  \brief P2 MAC Loopback Enable Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_LOOP_t {
    union {
        struct {
             uint32_t P2_LOOPBACK_EN   : 1; /**< MAC Loopback. */
             uint32_t RESERVED1        : 31; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P2_RX_CRC_EN P2 CRC Check Enable on Receive Register. (P2_RX_CRC_EN) Register
 *  P2 CRC Check Enable on Receive Register. (P2_RX_CRC_EN) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_CRC_EN_t
 *  \brief P2 CRC Check Enable on Receive Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_CRC_EN_t {
    union {
        struct {
             uint32_t P2_CRC_CHK_EN    : 1; /**< CRC Check Enable on Receive. */
             uint32_t RESERVED1        : 31; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_CRC_EN_t;

/*@}*/

/** @defgroup P2_RX_IFG P2 Receive Inter Frame Gap Register. (P2_RX_IFG) Register
 *  P2 Receive Inter Frame Gap Register. (P2_RX_IFG) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_IFG_t
 *  \brief P2 Receive Inter Frame Gap Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_IFG_t {
    union {
        struct {
             uint32_t P2_RX_IFG        : 6; /**< Inter Frame Gap. */
             uint32_t RESERVED6        : 26; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P2_RX_MAX_LEN P2 Max Receive Frame Length Register. (P2_RX_MAX_LEN) Register
 *  P2 Max Receive Frame Length Register. (P2_RX_MAX_LEN) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_MAX_LEN_t
 *  \brief P2 Max Receive Frame Length Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_MAX_LEN_t {
    union {
        struct {
             uint32_t P2_MAX_FRM_LEN   : 16; /**< Max Frame Length on Receive in Bytes. */
             uint32_t RESERVED16       : 16; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_MAX_LEN_t;

/*@}*/

/** @defgroup P2_RX_MIN_LEN P2 Min Receive Frame Length Register. (P2_RX_MIN_LEN) Register
 *  P2 Min Receive Frame Length Register. (P2_RX_MIN_LEN) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_RX_MIN_LEN_t
 *  \brief P2 Min Receive Frame Length Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_RX_MIN_LEN_t {
    union {
        struct {
             uint32_t P2_MIN_FRM_LEN   : 16; /**< Min Frame Length on Receive in Bytes. */
             uint32_t RESERVED16       : 16; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_RX_MIN_LEN_t;

/*@}*/

/** @defgroup P2_LO_RFC P2 Rx Low Priority FIFO Frame Count Register. (P2_LO_RFC) Register
 *  P2 Rx Low Priority FIFO Frame Count Register. (P2_LO_RFC) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_LO_RFC_t
 *  \brief P2 Rx Low Priority FIFO Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_LO_RFC_t {
    union {
        struct {
             uint32_t P2_LO_RFC        : 9; /**< Receive Frame Count for the Low Priority FIFO. */
             uint32_t RESERVED9        : 23; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P2_HI_RFC P2 Rx High Priority Fifo Frame Count Register. (P2_HI_RFC) Register
 *  P2 Rx High Priority Fifo Frame Count Register. (P2_HI_RFC) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_HI_RFC_t
 *  \brief P2 Rx High Priority Fifo Frame Count Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_HI_RFC_t {
    union {
        struct {
             uint32_t P2_HI_RFC        : 9; /**< Receive Frame Count for the High Priority FIFO. */
             uint32_t RESERVED9        : 23; /**< Reserved */
        };
        uint32_t VALUE32;
    };
...
/** @defgroup P2_LO_RXSIZE P2 Low Priority Rx FIFO Valid Half Words Register. (P2_LO_RXSIZE) Register
 *  P2 Low Priority Rx FIFO Valid Half Words Register. (P2_LO_RXSIZE) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_LO_RXSIZE_t
 *  \brief P2 Low Priority Rx FIFO Valid Half Words Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_LO_RXSIZE_t {
    union {
        struct {
             uint32_t P2_LO_RXSIZE     : 14; /**< Data in the Rx FIFO. Number of Half Words(16 Bit). */
             uint32_t RESERVED14       : 18; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_LO_RXSIZE_t;

/*@}*/

/** @defgroup P2_HI_RXSIZE P2 High Priority Rx FIFO Valid Half Words Register. (P2_HI_RXSIZE) Register
 *  P2 High Priority Rx FIFO Valid Half Words Register. (P2_HI_RXSIZE) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_HI_RXSIZE_t
 *  \brief P2 High Priority Rx FIFO Valid Half Words Register.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_HI_RXSIZE_t {
    union {
        struct {
             uint32_t P2_HI_RXSIZE     : 14; /**< Data in the Rx FIFO. Number of Half Words(16 Bit). */
             uint32_t RESERVED14       : 18; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_HI_RXSIZE_t;

/*@}*/

/** @defgroup P2TOP1_TXSIZE P2 to P1 TX Size. (P2TOP1_TXSIZE) Register
 *  P2 to P1 TX Size. (P2TOP1_TXSIZE) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2TOP1_TXSIZE_t
 *  \brief P2 to P1 TX Size.
 *  ======================================================================== */
typedef struct _ADI_MAC_P2TOP1_TXSIZE_t {
    union {
        struct {
             uint32_t P2TOP1_TXSIZE    : 14; /**< Data in P2 TX FIFO. Number of 16-bit Words to Transmit to. */
             uint32_t RESERVED14       : 18; /**< Reserved */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2TOP1_TXSIZE_t;

/*@}*/

/** @defgroup P2_TTSCAH Transmit Timestamp Capture Register A (High). (P2_TTSCAH) Register
 *  Transmit Timestamp Capture Register A (High). (P2_TTSCAH) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCAH_t
 *  \brief Transmit Timestamp Capture Register A (High).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCAH_t {
    union {
        struct {
             uint32_t P2_TTSCH_A       : 32; /**< P2 Transmit Timestamp A Bits 63-32. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCAH_t;
...
/** @defgroup P2_TTSCAL Transmit Timestamp Capture Register A (Low). (P2_TTSCAL) Register
 *  Transmit Timestamp Capture Register A (Low). (P2_TTSCAL) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCAL_t
 *  \brief Transmit Timestamp Capture Register A (Low).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCAL_t {
    union {
        struct {
             uint32_t P2_TTSCL_A       : 32; /**< P2 Transmit Timestamp A Bits 31-0. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCAL_t;
...
/** @defgroup P2_TTSCBH Transmit Timestamp Capture Register B (High). (P2_TTSCBH) Register
 *  Transmit Timestamp Capture Register B (High). (P2_TTSCBH) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCBH_t
 *  \brief Transmit Timestamp Capture Register B (High).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCBH_t {
    union {
        struct {
             uint32_t P2_TTSCH_B       : 32; /**< P2 Transmit Timestamp B Bits 63-32. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCBH_t;
...
/** @defgroup P2_TTSCBL Transmit Timestamp Capture Register B (Low). (P2_TTSCBL) Register
 *  Transmit Timestamp Capture Register B (Low). (P2_TTSCBL) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCBL_t
 *  \brief Transmit Timestamp Capture Register B (Low).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCBL_t {
    union {
        struct {
             uint32_t P2_TTSCL_B       : 32; /**< P2 Transmit Timestamp B Bits 31-0. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCBL_t;
...
/** @defgroup P2_TTSCCH Transmit Timestamp Capture Register C (High). (P2_TTSCCH) Register
 *  Transmit Timestamp Capture Register C (High). (P2_TTSCCH) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCCH_t
 *  \brief Transmit Timestamp Capture Register C (High).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCCH_t {
    union {
        struct {
             uint32_t P2_TTSCH_C       : 32; /**< P2 Transmit Timestamp C Bits 63-32. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCCH_t;
...
/** @defgroup P2_TTSCCL Transmit Timestamp Capture Register C (Low). (P2_TTSCCL) Register
 *  Transmit Timestamp Capture Register C (Low). (P2_TTSCCL) Register
 *  @{
 */

/*! ========================================================================
 *  \struct ADI_MAC_P2_TTSCCL_t
 *  \brief Transmit Timestamp Capture Register C (Low).
 *  ======================================================================== */
typedef struct _ADI_MAC_P2_TTSCCL_t {
    union {
        struct {
             uint32_t P2_TTSCL_C       : 32; /**< P2 Transmit Timestamp C Bits 31-0. */
        };
        uint32_t VALUE32;
    };
} ADI_MAC_P2_TTSCCL_t;
